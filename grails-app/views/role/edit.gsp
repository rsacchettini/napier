...
<html>
  ...
  <body>
    <div class="nav">
      ...
      <span class="menuButton"><g:link action="list">Roles List</g:link></span>
      <span class="menuButton"><g:link action="create">New Roles</g:link></span>
    </div>
    <div class="body">
      <h1>Edit Roles</h1>
            ...
            <tbody>     
			  <tr class='prop'>
			    <td valign='top' class='name'>
			    	<label for='authority'>Roles Name:</label>
			    </td>
				<td valign='top' 
