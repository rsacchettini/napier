                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${vendor.id}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${vendor.address}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${vendor.name}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${vendor.phone}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${vendor.properties}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${vendor.visits}</td>
